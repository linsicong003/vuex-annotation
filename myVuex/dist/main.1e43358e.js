...
exports.default = _default;
        var $6df2be = exports.default || module.exports;
      
      if (typeof $6df2be === 'function') {
        $6df2be = $6df2be.options;
      }
    
        /* template */
        Object.assign($6df2be, (function () {
          var render = function() {
  var _vm = this
  ...
  return _c("section", { staticClass: "container" }, [
    ...
    _vm._v(" "),
    _c("button", { on: { click: _vm.doCountDouble } }, [_vm._v("乘2")])
  ])
}
var staticRenderFns = []
    ...
    (function () {
      if (module.hot) {
        ...
        if (api.compatible) {
          module.hot.accept();
          if (!module.hot.data) {
            api.createRecord('$6df2be', $6df2be);
          } else {
            api.reload('$6df2be', $6df2be);
          }
        }
...
function () {
  function Store() {
    ...
    var _options$state = options.state,
        ...
        actions = _options$actions === void 0 ? {} : _options$actions; // 初始化
...
},{"./util":"src/store/util.js"}],"src/store/myVuex.js":[function(require,module,exports) {
"use strict";
...
exports.default = _default;
},{"./store.js":"src/store/store.js"}],"src/store/test.js":[function(require,module,exports) {
"use strict";
...
var store = new _myVuex.default.Store({
  state: {
    count: 1
  },
  getters: {
    ...
    getOne: function getOne(state) {
      return 1;
    }
  },
  mutations: {
    doCount: function doCount(state, data) {
      state.count = data;
    }
  },
  actions: {
    doCount: function doCount(_ref, data) {
      var commit = _ref.commit;
      commit('doCount', data);
    },
    doCountDouble: function doCountDouble(_ref2) {
...
var _default = store;
exports.default = _default;
},{"vue":"node_modules/vue/dist/vue.runtime.esm.js","./myVuex":"src/store/myVuex.js"}],"src/main.js":[function(require,module,exports) {
"use strict";
...
var _test = _interopRequireDefault(require("./store/test"));
...
},{"vue":"node_modules/vue/dist/vue.runtime.esm.js","./App.vue":"src/App.vue","./store/test":"src/store/test.js"}],"C:/Users/gutong/AppData/Local/Yarn/Data/global/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
...
},{}]},{},["C:/Users/gutong/AppData/Local/Yarn/Data/global/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","src/main.js"], null)
